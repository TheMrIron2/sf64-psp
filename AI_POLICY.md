...
This policy is derived from [Ghostty's AI Usage Policy](https://github.com/ghostty-org/ghostty/blob/main/AI_POLICY.md) and CrossCraft.

Star Fox 64 PSP has strict rules for AI usage:
...
Maintainers may use AI tools at their discretion.

Code that is not understood, or submitted without a human-written explanation,
will be rejected and the contributor may be blacklisted. 

## There are Humans Here

Please remember that Star Fox is maintained by humans.
...
SF64-PSP is written with AI assistance, and many maintainers embrace
