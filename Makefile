...
PSP_DIAG_SKIP_DEPTH_CLEAR ?= 0
PSP_DIAG_SKIP_TEX24_DRAW_ORDINAL ?= 0
USE_LOCAL_PSPGL ?= 0
PSP_LOG ?= 0
PSP_TRACE ?= 0
...
ifeq ($(PSP_DIAG_SKIP_DEPTH_CLEAR),1)
CFLAGS += -DPSP_DIAG_SKIP_DEPTH_CLEAR=1
endif
ifneq ($(PSP_DIAG_SKIP_TEX24_DRAW_ORDINAL),0)
CFLAGS += -DPSP_DIAG_SKIP_TEX24_DRAW_ORDINAL=$(PSP_DIAG_SKIP_TEX24_DRAW_ORDINAL)
endif
