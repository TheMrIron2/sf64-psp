...
PSP_ORIGINAL_FOG ?= 0
PSP_FOG_DISABLED ?= 0
PSP_FOG_ALPHA_VISUALIZE ?= 0
PSP_FOG_TRANSFER_COMPENSATE ?= 0
PSP_FOG_RDP_BLEND_QUANTIZE ?= 0
...
CFLAGS += -DPSP_ORIGINAL_FOG=$(if $(filter 1,$(PSP_ORIGINAL_FOG)),1,0)
CFLAGS += -DPSP_FOG_DISABLED=$(if $(filter 1,$(PSP_FOG_DISABLED)),1,0)
CFLAGS += -DPSP_FOG_ALPHA_VISUALIZE=$(if $(filter 1,$(PSP_FOG_ALPHA_VISUALIZE)),1,0)
CFLAGS += -DPSP_FOG_TRANSFER_COMPENSATE=$(if $(filter 1,$(PSP_FOG_TRANSFER_COMPENSATE)),1,0)
CFLAGS += -DPSP_FOG_RDP_BLEND_QUANTIZE=$(if $(filter 1,$(PSP_FOG_RDP_BLEND_QUANTIZE)),1,0)
